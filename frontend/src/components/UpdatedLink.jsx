  ...
  return (
    loading ? (
      ...
      <div className="p-5 m-3">
        <h1 className="text-2xl text-white text-center md:text-3xl font-bold mb-2">Updated List</h1>
        ...
        <div className="w-full md:w-96 h-72 overflow-y-auto scrollbar-hide rounded-md p-3 mt-6">
          {allUpdateList.map((list, id) => (
            <div key={id} className="border border-b-2 border-white text-white mt-6 p-3 mb-2 rounded-md hover:shadow-md transition-shadow" >
