...
//         <main className='flex bg-[#202020] justify-around'>
//             <div className='w-1/2 flex justify-center  flex-col'>
//                 <div className=" bottom-0 left-0 w-full h-1 bg-[#FF6200]"></div>
//                 <h1 className="md:text-6xl text-3xl font-bold mb-6 relative inline-block text-white text-left"> BLOG. </h1>
//             </div>
//             <div>
...
//         <div className='mt-5'>
//             <div className='w-1/2 flex justify-center  flex-col'>
//                 <h1 className=" text-2xl font-bold mb-2 relative inline-block text-white text-right"> MY OWN WRITINGS. </h1>
//                 <div className=" bottom-0 left-0 w-full h-1 bg-[#FF6200]"></div>
//             </div>
//             <div className="grid grid-cols-1 mt-2  md:grid-cols-4 gap-8 p-4">
//                 {
//                     blogs.map((blog, id) => (
      ...
      <main className="flex flex-col-reverse md:flex-row items-center bg-[#202020] justify-around p-4 md:p-8">
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <img
            ...
            alt="profile"
            className="rounded-md shadow-lg w-3/4 md:w-full max-w-sm md:max-w-md"
          />
        </div>
      </main>
